    ...
    <div className='max-w-[1640px] mx-auto p-4'>
        <div className='max-h-[500px] relative'>
            ...
            <div className='absolute w-1/2 h-full text-white max-h-[500px] bg-black/75 flex flex-col justify-center'>
                <h1 className='font-bold px-4 text-3xl md:text-6xl lg:text-7xl'>The <span className='text-orange-400'>Best</span></h1> <br/>
                <h1 className='font-bold px-4 -mt-5 md:mt-0 text-3xl md:text-6xl lg:text-7xl'>Food <span className='text-orange-400'>Delivered</span></h1>
            </div>
