    ...
    <div className="max-w-[1640px] px-4 lg:px-8 py-4 mx-auto flex justify-between">
      ...
      <div className="bg-gray-200 rounded-full flex items-center h-[40px] lg:h-[50px] px-4 w-[200px] sm:w-[300px] lg:w-[400px]">
        ...
        <input
          ...
          className="bg-transparent outline-none w-[100%] ml-4 capitalize"
          type="text"
          name=""
          id=""
      ...
      >
        ...
        <nav>
          <ul className="text-gray-800">
            <li className="flex items-center ml-4 py-4">
            ...
            <li className="flex items-center ml-4 py-4">
              <FaWallet size={18} className="mr-2" />
              Wallet
            </li>
            <li className="flex items-center ml-4 py-4">
            ...
            <li className="flex items-center ml-4 py-4">
              <BsFillSaveFill size={18} className="mr-2" />
              Best One
            </li>
            <li className="flex items-center ml-4 py-4">
